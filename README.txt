...
----------
	...
	Windows - Download and install Firefox (https://download.mozilla.org/?product=firefox-stub&os=win&lang=en-US)
		...
		- Download Gecko Driver (https://github.com/mozilla/geckodriver/releases), save it somewhere on your pc and put path to it into gradle\config.properties - path_to_gecko property
		- Restart Windows
